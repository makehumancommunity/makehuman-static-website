...
draft: false
weight: 1
description: "Release notes for MPFB 2.0.16"
---

These are the release notes of MPFB 2.0.16, which was released 2026-06-13. The following are changes since [2.0.15]({{% relref "release_2015" %}}).
