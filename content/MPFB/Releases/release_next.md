...
These are the release notes of what is to become MPFB 2.0.15. The following are changes since [2.0.14]({{% relref "release_2014" %}}).
...
The prior logic for installing asset packs assumed that asset pack zips where downloaded and installed as is.
...
There is now technical reference documentation for the UI layer in the docs dir.
